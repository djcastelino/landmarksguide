...
export const GUIDED_TOURS = [
  {
    ...
    stops: [
      ...
      { name: 'Station VIII', query: 'Via Dolorosa', description: 'Jesus meets and consoles the women of Jerusalem', landmark: 'Near Lutheran Church of the Redeemer', coords: { lat: 31.77793, lng: 35.23050 } },
